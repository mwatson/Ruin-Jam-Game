(function(root){
        ...
        var draw = function(_settings) {
                ...
                this.setOrigin = function(x, y) {
                        ...
                        _.each(this.canvas, function(canvas, id) {
                                if(canvas.originType == 'dynamic') {
                                        ...
                                        //if(x > self.bounds.x.max) {
                                                //canvas.origin.x = self.bounds.x.max;
                                        //} else if(x < self.bounds.x.min) {
                                                //canvas.origin.x = self.bounds.x.min;
                                        //} else {
                                                canvas.origin.x = x;
                                        //}

                                        //if(y > self.bounds.y.max) {
                                                //canvas.origin.y = self.bounds.y.max;
                                        //} else if(y < self.bounds.y.min) {
                                                //canvas.origin.y = self.bounds.y.min;
                                        //} else {
                                                canvas.origin.y = y;
                                        //}
                                }
                ...
                this.setResolution = function() {
                        ...
                        _.each(this.canvas, function(canvas){
                                canvas.setCanvasVisibleDimensions(winW, winH);
                        });

                        /*
                        this.mainCanvas.setCanvasVisibleDimensions(
                                winW, 
                                winH
                        );
                        */
                ...
                var canvasExtended = function(width, height, props) {
                        ...
                        this.setCanvasVisibleDimensions(_width, _height);
                ...
                this.init = (function(settings, self) {
                        ...
                        /*
                        self.mainCanvas = new canvasExtended(
                                                        settings.width, 
                                                        settings.height, 
                                                        { id: 'main', origin: 'fixed' }
                                                );
                        document.getElementsByTagName('body')[0].appendChild(self.mainCanvas.el);
                        */
